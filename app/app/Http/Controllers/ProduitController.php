...
class ProduitController extends Controller
{
    ...
    public function sauver_produit(ProductRequest $request){
        ...
        if($request->category == "Sélectionnez une Catégorie"){
            ...
            /*else{
                $data2 = array();
                $data2['nom_produit'] = $request->name;
                $data2['prix'] = $request->price;
                $data2['categorie'] = $request->category;
                $data2['product_image'] = $fileNameToStore;
                $data2['description_produit'] = $request->description_produit;
                $data2['allergenes'] = ' ';
