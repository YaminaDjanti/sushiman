...
class SingleProductController extends Controller
{
   ...
   public function ajouter_au_panierSingleProduct($id,$qty){
    ...
    public function ajouter_au_panierMultipleProducts(Request $request,$id,$qty,$accompagnement1,$accompagnement2 ){
        $url = $request->fullUrl();
        $accompagnement1 = $request->query('accompagnement1');
        $accompagnement2 = $request->query('accompagnement2');
