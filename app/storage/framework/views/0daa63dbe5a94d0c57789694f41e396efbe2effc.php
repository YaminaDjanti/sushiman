                    ...
                    <fieldset>
                        ...
                        <div class="form-group <?php echo e($errors->has('product_image')? 'has-error': ''); ?>">
                            ...
                            <?php echo e(Form::file('product_image', 
                                ...
                                <?php echo $errors->first('product_image', '<span class="help-block">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('description_produit')? 'has-error': ''); ?>">
                            ...
                            <?php echo $errors->first('description_produit', '<span class="help-block">:message</span>'); ?>
