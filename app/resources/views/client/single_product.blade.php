                         ...
                         <select  class=" subPrice" name="accompagnement1" style="color: gray;">
                            <option class="subPrice" style="color: gray;" >Sélectionnez un 1er accompagnement</option>
                                @foreach($accompagnements as $accompagnement)
                                    <option class="subPrice" style="color: gray;">{{$accompagnement->nom_produit}} </option>
                                    <option class="" type="hidden" style="color: gray;"  id="accompagnement1">{{$accompagnement}} </option>
                                @endforeach 
                        </select>  
                        @endif 
                        @if ($produit->categorie === 'Formules du midi')
                        ...
                        <h4 class="mt-2 text-left pt-2">Deuxième accompagnement de votre formule :</h4>
                         <select class=" subPrice" name="accompagnement2" style="color: gray;">
                            <option class="subPrice" style="color: gray;">Sélectionnez un 2nd accompagnement</option>
                                @foreach($accompagnements as $accompagnement)
                                    <option class="" style="color: gray;">{{$accompagnement->nom_produit}} </option>
                                    <option class="subPrice " type="hidden" style="color: gray;" id="accompagnement2" >{{$accompagnement}} </option>
                                @endforeach 
                        </select>  
                        @endif 
                    </div>
