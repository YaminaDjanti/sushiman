...
<?php $__env->startSection('content'); ?>
    ...
    <section id="home-section" class="hero">
        <div class="home-slider owl-carousel">
            ...
            <div class="slider-item" style="background-image: url(storage/slider_images/<?php echo e($slider->slider_image); ?>);">
                ...
                <div class="container">
                    <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                        ...
                        <p><a href="<?php echo e(URL::to('/about')); ?>" class="btn btn-primary" id="produitsList">Découvrir</a></p>
                        </div>
    ...
    <section class="">
    	...
    	<div class="container" id="containerPlateaux">
            ...
            <div class="row mb-5">
				<div class="col text-center">
					<div class="block-27">
						<?php echo e($produitsPlateaux->links()); ?>
            ...
            <div class="text-center mb-4">
                <a href="<?php echo e(URL::to('/select_by_cat/Plateaux')); ?>" class="btn btn-primary btn-outline-primary">Voir tous les plateaux</a>
    	...
    	<div class="container mt-3">
            ...
            <div class="row">
                <?php $__currentLoopData = $formuleMidis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formuleMidi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            <a href="<?php echo e(URL::to('/single_product/'.$formuleMidi->id)); ?>" class="img-prod"><img class="img-fluid" src="storage/cover_images/<?php echo e($formuleMidi->product_image); ?>" alt="<?php echo e($formuleMidi->product_image); ?>">
                            </a>
                            <div class="text py-3 pb-4 px-3 text-center">
                                <h3><a href="<?php echo e(URL::to('/single_product/'.$formuleMidi->id)); ?>"><?php echo e($formuleMidi->nom_produit); ?></a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span class="price-sale"><?php echo e($formuleMidi->prix); ?> €</span></p>
                                    </div>
                                        </div>
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        <a href="<?php echo e(URL::to('/single_product/'.$formuleMidi->id)); ?>" class="add-to-cart d-flex justify-content-center align-items-center text-center">
                                            <span><i class="ion-ios-menu"></i></span>
                                        </a>
            ...
            <div class="text-center mb-4">
                <a href="<?php echo e(URL::to('/select_by_cat/Formules du midi')); ?>" class="btn btn-primary btn-outline-primary">Voir toutes les formules</a>
            </div> 
        </div>
        <div class="container my-3">
            <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 shadow-sm p-3 mb-3 bg-white rounded">
                      ...
                      <p><a class="btn btn-primary btn-outline-primary mt-3" href="<?php echo e(URL::to('/select_by_cat/Accompagnements')); ?>" role="button">Voir tous les accompagnements &raquo;</a></p>
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 shadow-sm p-3 mb-3 bg-white rounded">
                        <div class="d-flex justify-content-center align-items-center">
                            <h2>Desserts</h2>
                        ...
                        <p><a class="btn btn-primary btn-outline-primary mt-3" href="<?php echo e(URL::to('/select_by_cat/Les desserts')); ?>" role="button">Voir tous les desserts &raquo;</a></p>
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 shadow-sm p-3 mb-3 bg-white rounded">
                        <div class="d-flex justify-content-center align-items-center">
                            <h2>Boissons</h2>
                      ...
                      <p><a class="btn btn-primary btn-outline-primary mt-3" href="<?php echo e(URL::to('/select_by_cat/Boissons')); ?>" role="button">Voir toutes les boissons &raquo;</a></p>
                    </div><!-- /.col-lg-4 -->
                  </div><!-- /.row -->
        ...
        <div class="text-center mb-4">
            <a href="<?php echo e(URL::to('/shop')); ?>" class="btn btn-primary btn-lg" >Voir tous les produits</a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" src="<?php echo e(asset('frontend/images/eat-aemporter2.jpg')); ?>" alt="Card image cap">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" src="<?php echo e(asset('frontend/images/eat-livraison.2.jpg')); ?>" alt="Card image cap">
                            <div class="card-body card-height">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" src="<?php echo e(asset('frontend/images/eat-surplace2.jpg')); ?>" alt="Card image cap">
                        <div class="card-body card-height">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sushiman\sushiman\resources\views/client/home.blade.php ENDPATH**/ ?>