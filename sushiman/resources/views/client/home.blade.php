    		...
    		<div class="row">
                @foreach($produitsPlateaux as $produitsPlateau)
                    <div class="col-md-6 col-lg-3 ftco-animate hauteur-limite-card pb-2">
                        <div class="product">
                            <a href="{{URL::to('/single_product/'.$produitsPlateau->id)}}" class="img-prod card-img d-block"><img class="img-fluid" src="storage/cover_images/{{$produitsPlateau->product_image}}" alt="{{$produitsPlateau->product_image}}"> 
                            </a>
