...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  <div class="container">
  <a class="navbar-brand" href="{{URL::to('/')}}">M.Sushi</a>
  ...
  <div class="collapse navbar-collapse" id="ftco-nav">
      ...
      <li class="nav-item active"><a href="{{URL::to('/shop')}}" class="nav-link">La Carte</a></li>
      <li class="nav-item active"><a href="{{URL::to('/about')}}" class="nav-link">A propos</a></li>
      <li class="nav-item active"><a href="{{URL::to('/contact')}}" class="nav-link">Contact</a></li>
      
      <li class="nav-item cta cta-colored"><a href="{{URL::to('/panier')}}" class="nav-link">Panier<span class="icon-shopping_cart"></span>[{{Session::has('panier')?count(Session::get('panier')->items):0}}]</a></li>
