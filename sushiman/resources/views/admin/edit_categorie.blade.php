...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row grid-margin">
            ...
            <div class="card">
                <div class="card-body">
                <h4 class="card-title">Éditer catégorie</h4>
                <?php 
                ...
                @endif
                    ...
                    {{ Form::open(array(
                        'action' => 'CategoryController@modifier_categorie',
                        'method' => 'POST',
                    ...
                    <input id="id-hidden" class="form-control" name="id" minlength="2" type="hidden" value="{{$categories->id}}">
                    </div>
