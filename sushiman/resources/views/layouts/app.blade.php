  ...
  <!-- Jquery/Boostrap general-->
   ...
   <script type="text/javascript">
      jQuery("#addto_cart").click(function(){
        ...
        var produitCategorie = $('#produitCategorie').val(); 
        var accompagnement1Nom = $('#accompagnement1').val();
        var accompagnement2Nom = $('#accompagnement2').val();

        
        if(produitCategorie === "Formules du midi"){

        var accompagnement1 = $('#accompagnement1').val();
          jQuery(location).attr('href', APP_URL+'/ajouter_au_panierMultipleProducts/'+productid+'/'+qty+'?'+'accompagnement1qs='+accompagnement1Nom+'&accompagnement2qs='+accompagnement2Nom);
